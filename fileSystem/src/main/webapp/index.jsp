	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">文件共享系统</span>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="upload.jsp" target="right">
							<li>文件上传</li>
						</a>
						<a href="fileList" target="right">
							<li>文件查看</li>
						</a>
					</ul>
				</li>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="upload.jsp" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
